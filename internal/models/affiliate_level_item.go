...
type AffiliateLevelItem struct {
	...
	UpgradeMetricType     string               `gorm:"type:varchar(20);not null;default:''" json:"upgrade_metric_type"`
	UpgradePeriodType     string               `gorm:"type:varchar(20);not null;default:''" json:"upgrade_period_type"`
